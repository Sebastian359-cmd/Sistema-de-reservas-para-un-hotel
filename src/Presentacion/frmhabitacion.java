...
private static final Logger logger = LoggerFactory.getLogger(frmhabitacion.class);
    ...
    void habilitar() {
     ...
     void mostrar(String buscar) {
        try {
            ...
            logger.error("Error mostrando habitaciones con filtro '{}'", buscar, e);
            JOptionPane.showMessageDialog(rootPane, "Ocurrió un error al mostrar los datos, revisa el log.");
        }
    }
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (txtcaracteristicas.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Debes ingresar una característica para la Habitación Habitación");
   ...
   private Connection connection=new conexion().conectar();
    ...
    try {
        // Ruta del archivo .jrxml (no .jasper)
        String reportPath = "C:\\Users\\sebas\\JaspersoftWorkspace\\MyReports\\ReporteCielo.jrxml";

        // Compila el reporte en tiempo de ejecución
        report = JasperCompileManager.compileReport(reportPath);

        // Llena el reporte con los datos desde la base
        print = JasperFillManager.fillReport(report, p, connection);

        // Muestra el visor del reporte
        JasperViewer view = new JasperViewer(print, false);
        view.setTitle("Reporte de Habitaciones");
        view.setVisible(true);

    } catch (Exception e) {
        // Muestra mensaje de error y escribe en log si lo tienes configurado
        JOptionPane.showMessageDialog(rootPane, "Error al generar el reporte: " + e.getMessage());
        e.printStackTrace(); // o logger.error(...) si usas log4j/slf4j
    }
