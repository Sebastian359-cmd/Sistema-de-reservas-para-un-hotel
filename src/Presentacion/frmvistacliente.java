...
public class frmvistacliente extends javax.swing.JFrame {
    private static final Logger logger = LoggerFactory.getLogger(frmvistacliente.class);
    ...
    void ocultar_columnas() {
      ...
      void mostrar(String buscar) {
        try {
            ...
            logger.error("Error mostrando clientes con filtro: " + buscar, e);
            JOptionPane.showMessageDialog(rootPane, "Error al cargar los clientes. Contacte al administrador.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
