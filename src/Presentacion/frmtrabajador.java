...
public class frmtrabajador extends javax.swing.JInternalFrame {
 private static final Logger logger = LoggerFactory.getLogger(frmtrabajador.class);
    /**
...
void mostrar(String buscar) {
    try {
        ...
        logger.info("Mostrando trabajadores con filtro: '{}'. Total encontrados: {}", buscar, func.totalregistros);

    } catch (Exception e) {
        logger.error("Error al mostrar los trabajadores con filtro: '{}'", buscar, e);
        JOptionPane.showMessageDialog(rootPane, "Ocurrió un error al cargar los trabajadores. Revisa el log para más detalles.");
    }
}
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (txtapaterno.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Debes ingresar un apellido para el Trabajador");
        ...
        if (txtnum_documento.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Debes ingresar un Número de Doc para el Trabajador");
