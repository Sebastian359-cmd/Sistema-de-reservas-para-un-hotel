...
public static String cliente;
    ...
    void mostrar(String buscar) {
        try {
            ...
            logger.error("Error mostrando consumo para reserva '{}': ", buscar, e);
        JOptionPane.showMessageDialog(this, "Error al mostrar los datos. Revise los logs.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    try {
        ...
        // Conexión a la base de datos para obtener el precio unitario
        Connection cn = DriverManager.getConnection("jdbc:mysql://localhost/Basereserva", "root", "");
        PreparedStatement pst = (PreparedStatement) cn.prepareStatement("SELECT precio_venta FROM producto WHERE idproducto = ?");
        ...
        txtprecio_venta.setText(String.format("%.2f", total));

    } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Ingrese un número válido en cantidad.");
    } catch (Exception e) {
        JOptionPane.showMessageDialog(this, "Error al calcular el precio: " + e.getMessage());
    }
}
    ...
    private void initComponents() {
        ...
        btnbuscar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnbuscar1btnCalcularActionPerformed(evt);
            }
        });
    ...
    private void btnbuscar1btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscar1btnCalcularActionPerformed
     calcularPrecioTotal();
    }//GEN-LAST:event_btnbuscar1btnCalcularActionPerformed
