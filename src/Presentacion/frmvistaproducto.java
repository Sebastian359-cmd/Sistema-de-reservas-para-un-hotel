...
public class frmvistaproducto extends javax.swing.JFrame {
    private static final Logger logger = LoggerFactory.getLogger(frmvistaproducto.class);
...
void mostrar(String buscar) {
        try {
            ...
            logger.error("Error mostrando datos con filtro: " + buscar, e);
            JOptionPane.showMessageDialog(rootPane, "Error al cargar datos. Contacte al administrador.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    /**
