...
public class frmvistahabitacion extends javax.swing.JFrame {
    private static final Logger logger = LoggerFactory.getLogger(frmvistahabitacion.class);
    ...
    public frmvistahabitacion() {
     ...
     void mostrar(String buscar) {
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Error al cargar las habitaciones. Contacte al administrador.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
