...
private static final Logger logger = LoggerFactory.getLogger(frmcliente.class);
    /**
    ...
    try {
            ...
            logger.info("Mostrar clientes con filtro '{}', total registros: {}", buscar, func.totalregistros);

        } catch (Exception e) {
            logger.error("Error al mostrar clientes con filtro '{}'", buscar, e);
            JOptionPane.showMessageDialog(rootPane, "Error al mostrar clientes: " + e.getMessage(),
...
if (txtnum_documento.getText().length() == 0) {
    JOptionPane.showMessageDialog(rootPane, "Debes ingresar un Número de Doc para el cliente");
