...
public class frmusuariologin extends javax.swing.JFrame {
 private static final Logger logger = LoggerFactory.getLogger(frmusuariologin.class);
    /**
    ...
    try {
            ...
            logger.error("Error en btningresarActionPerformed: ", e);
            JOptionPane.showMessageDialog(rootPane, "Ocurrió un error inesperado. Contacte al administrador.", "Error", JOptionPane.ERROR_MESSAGE);
        }
