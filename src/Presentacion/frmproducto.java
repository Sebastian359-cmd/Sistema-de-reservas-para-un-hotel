...
public class frmproducto extends javax.swing.JInternalFrame {
    private static final Logger logger = LoggerFactory.getLogger(frmproducto.class);
    ...
    void mostrar(String buscar) {
        try {
            ...
            logger.error("Error al mostrar datos con parámetro: " + buscar, e);
            // Opcional: mostrar mensaje amigable al usuario
            JOptionPane.showMessageDialog(rootPane, "Error al cargar los datos.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (txtdescripcion.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Debes ingresar una descripción para el producto");
            txtdescripcion.requestFocus();
            return;
        }

        if (txtprecio_venta.getText().length() == 0) {
            JOptionPane.showMessageDialog(rootPane, "Debes ingresar un precio diario para para la venta del producto");
